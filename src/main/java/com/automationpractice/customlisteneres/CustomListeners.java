package com.automationpractice.customlisteneres;
...
import static com.automationpractice.utility.Utilities.takeScreenShot;
...
public class CustomListeners implements ITestListener {
    ...
    public void onStart(ITestContext iTestContext) {
        ...
        reporter.config().setReportName("AutomationPractice website testing");
